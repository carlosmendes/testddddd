...
class InvoiceLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_line" do
    assert_difference('InvoiceLine.count') do
      post invoice_lines_url, params: { invoice_line: { invoice_id: @invoice_line.invoice_id, track_id: @invoice_line.track_id, unit_price: @invoice_line.unit_price } }
    end
  ...
  test "should update invoice_line" do
    patch invoice_line_url(@invoice_line), params: { invoice_line: { invoice_id: @invoice_line.invoice_id, track_id: @invoice_line.track_id, unit_price: @invoice_line.unit_price } }
